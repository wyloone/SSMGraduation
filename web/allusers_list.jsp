				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td style="font-size:25px; height: 50px" colspan="17">管理员账户列表</td>
						</tr>
					</table>
				</td>
			</tr>
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
                          <tr>
							  ...
							  <td width="15%" height="30" align="center" bgcolor='#ebf0f7'>账号</td>
							  <td width="15%" height="30" align="center"  bgcolor='#ebf0f7'>密码</td>
							  <td width="15%" height="30" align="center"  bgcolor='#ebf0f7'>权限</td>

							  <td width="25%" height="30" align="center" bgcolor="#ebf0f7"> 添加时间 </td>
							  <td width="25%" height="30" align="center" bgcolor="#ebf0f7"> 操作 </td>
                          </tr>
                          <%
					int i=0;
				%>
