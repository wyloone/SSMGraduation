				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td style="font-size:25px; height: 50px" height="30" colspan="17" background="images/table_header.gif">留言板列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						...
						<tr align="left" >
							<td height="30" colspan="17">
								<form action="liuyanbanList.do" name="myform" method="post">
									查询   昵称：<input name="cheng" type="text" id="cheng" class="form-control2" />
									QQ号：<input name="QQ" type="text" id="QQ" class="form-control2" />
                          ...
                          <tr>
                           <%-- <td width="30px" height="30" align="center" bgcolor="#ebf0f7">序号</td>
                            ...
                            <td width="150px" height="30" align="center" bgcolor="#ebf0f7"> 操作 </td>--%>
							  ...
							  <td height="10%" align='center' bgcolor="#ebf0f7">昵称</td>
							  <td  width='15%' height="30" align='center' bgcolor="#ebf0f7">表情</td>
							  <td height="10%" align='center' bgcolor="#ebf0f7">QQ</td>
							  <td height="10%" align='center' bgcolor="#ebf0f7">邮箱</td>
							  <td height="8%" align='center' bgcolor="#ebf0f7">手机</td>
							  <td height="10%" align='center' bgcolor="#ebf0f7">内容</td>
							  <td height="13%" align='center' bgcolor="#ebf0f7">回复内容</td>

							  <td width="6%" height="30" align="center" bgcolor="#ebf0f7"> 添加时间 </td>
							  <td width="13%" height="30" align="center" bgcolor="#ebf0f7"> 操作 </td>
                          </tr>
                          <%
					int i=0;
				%>
				...
				%>
							...
							<td>${u.huifuneirong}</td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateLiuyanbanlb.do?id=${u.id }">回复</a>
								  <a class="btn btn-info btn-small" href="deleteLiuyanban.do?id=${u.id }"
