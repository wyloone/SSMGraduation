				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">报名列表</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				%>
                            <tr align="center">
                             ...
                             <td>${u.huodongmingcheng}</td>    <td>${u.huodongkaishishijian}</td>    <td>${u.huodongjieshushijian}</td>    <td>${u.huodongdizhi}</td>    <td>${u.tuanduizhanghao}</td>    <td>${u.tuanduimingcheng}</td>    <td>${u.lianxidianhua}</td>    <td>${u.baomingren}</td>    
                              ...
                              <td height="50" align="center"> <!--lianjie1--> <a class="btn btn-info btn-small" href="bmDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
