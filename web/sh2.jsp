...
%>
  ...
  <body style="background: url(upload/back02.jpg)" >
    ...
    <table width="32%" height="193" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="black" style="border-collapse:collapse">
    <tr>
      <td style="font-size:25px; height: 50px" colspan="2"><div align="center">在线审核</div></td>
    </tr>
    <tr>
