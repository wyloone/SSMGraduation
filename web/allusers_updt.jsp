	...
	<body style="background: url(upload/back02.jpg)">
			<form action="updateAllusers.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td style="font-size:25px; height: 50px" colspan="2" background="images/table_header.gif">修改管理员账号
		...
		<tr >
		  <td width="200">密码：</td>
		  <td><input name='pwd' type='text' id='pwd' value='' onblur='checkform()' readonly class="form-control" />&nbsp;*<label id='clabelpwd' style="margin-top:16px;" /></td></tr>
		<tr >
		  <td width="200">权限：</td>
