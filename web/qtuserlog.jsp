                             ...
                             <td height='28'>密码:</td>
                              ...
                              <tr >
                                ...
                                <td height='28' colspan='2'>
                                   <%-- <select name='cx' id='cx' class="user" >
                                      <option value='志愿者'>志愿者</option>
                                     <option value='志愿团队'>志愿团队</option>
                                     </select>--%>
                                      志愿者<input type="radio" name='cx' id='cx'  value='志愿者' onclick="show();">
                                      志愿团队<input type="radio" name='cx' id='cx'  value='志愿团队'checked onclick="hidd();">
                                </td>
                              </tr>
                              <tr >
                                <td height='28'>&nbsp;</td>
