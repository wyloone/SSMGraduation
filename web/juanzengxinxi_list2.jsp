...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="juanzengxinxiList2.do" name="myform" method="post">
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7" class="table table-striped table-bordered table-hover">
                          <tr>
                            ...
                            <td align='center' bgcolor='#ebf0f7'>捐赠编号</td>
							<td  width='65' align='center' bgcolor='#ebf0f7'>捐赠时间</td>

							<td  width='90' align='center' bgcolor='#ebf0f7'>物资图片</td>
							<td align='center' bgcolor='#ebf0f7'>捐赠人</td>
                            ...
                            <td width="150px" height="30" align="center" bgcolor="#ebf0f7"> 操作 </td>--%>
								...
								<td align='center' bgcolor='#ebf0f7' width="25%">物资图片</td>
								<td align='center' bgcolor='#ebf0f7' width="10%">捐赠人</td>

								<td width="15%" height="30" align="center" bgcolor="#ebf0f7"> 添加时间 </td>
								<td width="15%" height="30" align="center" bgcolor="#ebf0f7"> 操作 </td>
                          </tr>
                          <%
					int i=0;
				%>
				...
				%>
							...
							<td>${u.juanzengren}</td>
                              ...
                              <td height="45" align="center">
								  ...
								  <a class="btn btn-info btn-small" href="deleteJuanzengxinxi.do?id=${u.id }" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a>
		 ...
		 <c:if test="${page.page>1}">
              <a href="juanzengxinxiList2.do?page=1" >首页</a>
             <a href="juanzengxinxiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="juanzengxinxiList2.do?page=${page.page+1 }">下一页</a>
			<a href="juanzengxinxiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
