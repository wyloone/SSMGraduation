...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShequxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改社区信息<input type="hidden" name="id" value="${shequxinxi.id}" /></td>
						</tr>
		...
		<tr ><td width="200">社区地址：</td><td><input name='shequdizhi' type='text' id='shequdizhi' value='' onblur='' class="form-control" /></td></tr>
						...
						<script language="javascript">document.form1.shequbianhao.value='${shequxinxi.shequbianhao}';</script>
						<script language="javascript">document.form1.shequmingcheng.value='${shequxinxi.shequmingcheng}';</script>
						<script language="javascript">document.form1.shequzhaopian.value='${shequxinxi.shequzhaopian}';</script>
						<script language="javascript">document.form1.shequdianhua.value='${shequxinxi.shequdianhua}';</script>
						<script language="javascript">document.form1.shequdizhi.value='${shequxinxi.shequdizhi}';</script>
