...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body style="background: url(upload/back02.jpg)">
			<form action="updateJuanzengxinxi.do" name="form1" method="post">
				<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
				<tr bgcolor="#E7E7E7">
					<td style="font-size:25px; height: 50px" colspan="2" background="images/table_header.gif">修改捐赠信息<input type="hidden" name="id" value="${juanzengxinxi.id}" /></td>
				</tr>
				...
				<tr ><td width="200">捐赠人：</td><td><input name='juanzengren' type='text' id='juanzengren' onblur='' class="form-control" value='<%=(String)request.getSession().getAttribute("username")%>' readonly="readonly" /></td></tr>
						...
						<script language="javascript">document.form1.juanzengbianhao.value='${juanzengxinxi.juanzengbianhao}';</script>
	<script language="javascript">document.form1.juanzengshijian.value='${juanzengxinxi.juanzengshijian}';</script>
	<script language="javascript">document.form1.juanzengneirong.value='${juanzengxinxi.juanzengneirong}';</script>
	<script language="javascript">document.form1.wuzitupian.value='${juanzengxinxi.wuzitupian}';</script>
	<script language="javascript">document.form1.juanzengren.value='${juanzengxinxi.juanzengren}';</script>
