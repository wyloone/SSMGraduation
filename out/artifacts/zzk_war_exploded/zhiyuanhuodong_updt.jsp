...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body style="background: url(upload/back02.jpg)">
			<form action="updateZhiyuanhuodong.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td style="font-size:25px; height: 50px" colspan="2" background="images/table_header.gif">修改志愿活动<input type="hidden" name="id" value="${zhiyuanhuodong.id}" /></td>
						</tr>
		...
		<tr ><td width="200">联系电话：</td><td><input name='lianxidianhua' type='text' id='lianxidianhua' value='' onblur='' class="form-control" /></td></tr><script language="javascript">document.form1.lianxidianhua.value='<%=connDbBean.readzd("zhiyuantuandui","lianxidianhua","tuanduizhanghao",(String)request.getSession().getAttribute("username"))%>';document.form1.lianxidianhua.setAttribute("readOnly",'true');</script>
						...
						<script language="javascript">document.form1.huodongmingcheng.value='${zhiyuanhuodong.huodongmingcheng}';</script>
					<script language="javascript">document.form1.huodongkaishishijian.value='${zhiyuanhuodong.huodongkaishishijian}';</script>
					<script language="javascript">document.form1.huodongjieshushijian.value='${zhiyuanhuodong.huodongjieshushijian}';</script>
					<script language="javascript">document.form1.huodongneirong.value='${zhiyuanhuodong.huodongneirong}';</script>
					<script language="javascript">document.form1.huodongdizhi.value='${zhiyuanhuodong.huodongdizhi}';</script>
					<script language="javascript">document.form1.tuanduizhanghao.value='${zhiyuanhuodong.tuanduizhanghao}';</script>
					<script language="javascript">document.form1.tuanduimingcheng.value='${zhiyuanhuodong.tuanduimingcheng}';</script>
					<script language="javascript">document.form1.chuangjianren.value='${zhiyuanhuodong.chuangjianren}';</script>
					<script language="javascript">document.form1.lianxidianhua.value='${zhiyuanhuodong.lianxidianhua}';</script>
