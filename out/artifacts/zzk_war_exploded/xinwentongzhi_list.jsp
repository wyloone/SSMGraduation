				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td style="font-size:25px; height: 50px" colspan="17" background="images/table_header.gif">新闻通知列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xinwentongzhiList.do?lb=疫情防控消息" name="myform" method="post">
									查询   标题：<input name="biaoti" type="text" id="biaoti" class="form-control2" />
									<%--类别：<input name="leibie" type="text" id="leibie" class="form-control2" />--%>
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
                          <tr>
                            ...
                            <td width="39%" height="30" align='center' bgcolor="#ebf0f7">标题</td>
							<td width="8%"height="30" align='center' bgcolor="#ebf0f7">类别</td>

							<td width="12%" height="30" align='center' bgcolor="#ebf0f7">首页图片</td>
							<td width="8%" align='center' bgcolor="#ebf0f7">点击率</td>
							<td width="8%" height="30" align='center' bgcolor="#ebf0f7">添加人</td>
				...
				%>
							...
							<td>${u.tianjiaren}</td>
                              ...
                              <td width="220" align="center">
								  <%--<a class="btn btn-info btn-small" href="doUpdateXinwentongzhi.do?id=${u.id }">编辑</a>--%>
								  <a class="btn btn-info btn-small" href="deleteXinwentongzhi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a>
								  <%--<a class="btn btn-info btn-small" href="xwtzDetail.do?id=${u.id}" target="_blank">详细</a>--%></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
