      ...
      <tr>
         ...
         <td>&nbsp;</td><td>&nbsp;</td></tr><tr>
           <td colspan=4 align=center>
             <c:if test="${zhiyuanhuodong.huodongjieshushijian<currentTime}">
                 <input type=button name=Submit5 value=返回 class='hsgqiehuanshitu' onClick="javascript:history.back()" />
                 <input type=button name=Submit53 class='hsgqiehuanshitu' value=不能报名 />
                 <input type=button name=Submit52 value=打印 class='hsgqiehuanshitu' onClick="javascript:window.print()" />
             </c:if>
            <c:if test="${zhiyuanhuodong.huodongjieshushijian>=currentTime}">
                <input type=button name=Submit5 value=返回 class='hsgqiehuanshitu' onClick="javascript:history.back()" />
                <input type=button name=Submit53 class='hsgqiehuanshitu' value=报名 onClick="javascript:location.href='baomingadd.jsp?id=<%=request.getParameter("id")%>';"/>
                <input type=button name=Submit52 value=打印 class='hsgqiehuanshitu' onClick="javascript:window.print()" />
            </c:if>
         </td>
      </tr>
