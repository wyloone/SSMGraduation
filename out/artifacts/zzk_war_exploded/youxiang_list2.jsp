...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td style="font-size:25px; height: 50px" colspan="17" background="images/table_header.gif">已发送邮件</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="youxiangList2.do" name="myform" method="post">
                          ...
                          <tr>
                           <%-- <td width="30px" height="30" align="center" bgcolor="#ebf0f7">序号</td>
                            ...
                            <td width="150px" height="30" align="center" bgcolor="#ebf0f7"> 操作 </td>--%>
							  ...
							  <td align='center' bgcolor='#ebf0f7' width="15%">收件人</td>
							  <td align='center' bgcolor='#ebf0f7' width="15%">发件人</td>
							  <td align='center' bgcolor='#ebf0f7' width="40%">标题</td>
				...
				%>
							...
							<td>${u.biaoti}</td>
                              ...
                              <td height="45" align="center"> <a class="btn btn-info btn-small" href="deleteYouxiang.do?id=${u.id }" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="doUpdateYouxiang.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="youxiangDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="youxiangList2.do?page=1" >首页</a>
             <a href="youxiangList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="youxiangList2.do?page=${page.page+1 }">下一页</a>
			<a href="youxiangList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
