...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="jiarutuanduiList2.do" name="myform" method="post">
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7" class="table table-striped table-bordered table-hover">
                          <tr>
							...
							<td align='center' bgcolor='#ebf0f7' width="9%">加入人</td>
							<td align='center' bgcolor='#ebf0f7' width="10%">志愿者姓名</td>
							<td width="8%" align='center' bgcolor='#ebf0f7'>是否审核</td><td width="10%" align='center' bgcolor='#ebf0f7'>审核回复</td>
				...
				%>
							...
							<td align='center' >${u.issh}</td><td>${u.shhf}</td>
                              ...
                              <td height="45" align="center">
								  <a class="btn btn-info btn-small" href="deleteJiarutuandui.do?id=${u.id }" onclick="{if(confirm('确定要退出吗?')){return true;}return false;}">退出</a>
		 ...
		 <c:if test="${page.page>1}">
              <a href="jiarutuanduiList2.do?page=1" >首页</a>
             <a href="jiarutuanduiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="jiarutuanduiList2.do?page=${page.page+1 }">下一页</a>
			<a href="jiarutuanduiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
	...
	<%
		...
		String sql="";
		sql="select count(id) as gwegwg  from jiarutuandui where issh='待审核' and jiaruren='"+request.getSession().getAttribute("username")+"'";
	...
	<div id="winpop">
		...
		<div class="con">当前有<%=bb%>条加入团队记录待审核！</div>
