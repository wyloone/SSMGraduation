...
function gows()
{
	document.location.href="zhiyuantuandui_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body style="background: url(upload/back02.jpg)">
			<form action="updateZhiyuantuandui.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td style="font-size:25px; height: 50px" colspan="2" background="images/table_header.gif">修改志愿团队<input type="hidden" name="id" value="${zhiyuantuandui.id}" /></td>
						</tr>
						<tr ><td width="200">团队帐号：</td><td><input name='tuanduizhanghao' type='text' id='tuanduizhanghao' readonly value='' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabeltuanduizhanghao' style='margin-top:16px;' /></td></tr>
		<tr ><td width="200">密码：</td><td><input name='mima' type='text' id='mima' value='' onblur='checkform()' readonly class="form-control" />&nbsp;*<label id='clabelmima' style='margin-top:16px;' /></td></tr>
