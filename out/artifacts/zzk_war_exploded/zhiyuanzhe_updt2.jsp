	...
	<body style="background: url(upload/back02.jpg)">
			<form action="updateZhiyuanzhe2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<tr ><td width="200">志愿者账号：</td><td><input name='zhiyuanzhezhanghao' type='text' id='zhiyuanzhezhanghao' value='' onblur='hsgcheck()' class="form-control" readonly='readonly'/>&nbsp;*<label id='clabelzhiyuanzhezhanghao' style='margin-top:16px;' /></td></tr>
