...
public class IndexController {
	...
	@Resource
private JuanzengxinxiServer juanzengxinxiServer;
@Resource
private ShequxinxiServer shequxinxiServer;
...
//	首页显示内容
	...
	public String showIndex(ModelMap map){
		...
		List<Juanzengxinxi> syjuanzengxinxi=juanzengxinxiServer.getsyjuanzengxinxi1(null);
List<Shequxinxi> syshequxinxi=shequxinxiServer.getsyshequxinxi1(null);
	    ...
	    map.put("syjuanzengxinxi", syjuanzengxinxi);
		map.put("syshequxinxi", syshequxinxi);
